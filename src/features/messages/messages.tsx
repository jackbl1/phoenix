    ...
    <div>
      ...
      <div className="hero min-h-screen bg-gradient-to-r from-warning to-secondary">
        <div className="drawer drawer-mobile">
            ...
            <label htmlFor="my-drawer-2" className="btn btn-warning btn-shadow drawer-button place-self-top lg:hidden">Messages</label>

            <div className="hero w-full rounded-lg bg-neutral shadow m-3 ">
                <div className="text-neutral-content">
                    <div className="max-w-full m-5">
                    <h1 className="top-0 mb-5 text-5xl font-bold align-top">Jenny from the block</h1>
