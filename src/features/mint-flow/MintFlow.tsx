            ...
            <div className="max-w-md">
              <h1 className="mb-5 text-5xl font-bold text-primary font-patrick">
                ...
                <p className="mb-5 text-primary text-xl font-patrick">
                  Press the button to scan your ticket's QR code to
                  redeem your Phoenix NFT!
                </p>
                {!scan && (
                  <button className="h-12 px-6 m-2 text-xl text-neutral transition-colors duration-150 bg-warning rounded-lg focus:shadow-outline hover:bg-secondary" onClick={() => setScan(true)}>
                    Redeem NFT
                  </button>
                )}
                {scan && (
