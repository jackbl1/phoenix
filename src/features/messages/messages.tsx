    ...
    <div>
      ...
      <div className="hero min-h-screen bg-gradient-to-r from-warning to-secondary">
        <div className="drawer drawer-mobile h-3/4">
            ...
            <label htmlFor="my-drawer-2" className="btn btn-warning btn-shadow drawer-button place-self-top lg:hidden">Chats</label>
            ...
            <div className="grid grid-cols-1 h-full w-11/12 rounded-lg bg-neutral shadow relative overflow-scroll">
                ...
                <div className="grid grid-cols-1 w-full p-5 gap-5 place-items-top overflow-scroll">
                    <div className="grid grid-cols-10 bg-base-100 rounded-xl w-full h-auto p-2 aling-left">
                        ...
                        <div className="col-start-2 col-end-10">
                            <div className="text-lg text-neutral">I've been popping pills man I feel just like a rock star.</div>
                        </div>
                    </div>
                    <div className="grid grid-cols-10 bg-base-100 rounded-xl w-full h-auto p-2 aling-left">
                        <div className="cols-start-1">
                        ...
                        <div className="col-start-2 col-end-10">
                            <div className="text-lg text-neutral">Man I fucking love posty.</div>
                        </div>
                    </div>
                    <div className="grid grid-cols-10 bg-base-100 rounded-xl w-full h-auto p-2 aling-left">
                        <div className="cols-start-1">
                        ...
                        <div className="col-start-2 col-end-10">
                            <div className="text-lg text-neutral">did you hear that he is playing in LA next week?</div>
                        </div>
                    </div>
                    <div className="grid grid-cols-10 bg-base-100 rounded-xl w-full h-auto p-2 aling-left">
                        <div className="cols-start-1">
                ...
                <div className="bottom-0 align-self-center w-full bg-neutral">
                    <input type="text" placeholder="Type here" className="input input-bordered text-neutral w-10/12 m-3" />
